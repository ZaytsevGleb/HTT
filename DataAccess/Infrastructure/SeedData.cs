...
public static class SeedData
{
    ...
    private static async Task CreateCategories(ApplicationDbContext db)
    {
        ...
        var berrieCategory = new Category
        {
            Id = Guid.NewGuid(),
            Name = "Berries",
            CreatedDate = DateTime.Now,
        ...
        berrieCategory.Products = berries;

        db.Categories.AddRange(fruitCategory, vegetableCategory, berrieCategory);
